  ...
  <div class="space-y-4">
    ...
    <div v-if="form.parent_id > 0">
      ...
      <div class="alert alert--warning">
        Некоторые места находятся за пределами населенных пунктов. Если добавляемое вами место подходит под этот случай,
        то пропустите выбор населенного пункта.<br /><br />В другом случае населенных пункт должен быть выбран, а если подходящего населенного пункта не найдено,
